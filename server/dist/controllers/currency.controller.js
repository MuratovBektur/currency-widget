...
var currency_model_1 = __importDefault(require("../models/currency.model"));
var RecordController = /** @class */ (function () {
    function RecordController() {
    }
    RecordController.prototype.getAll = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _b = (_a = JSON).parse;
                        return [4 /*yield*/, currency_model_1["default"].getAll()];
                    case 1:
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        id = req.params.id;
                        _c = (_b = JSON).parse;
                        return [4 /*yield*/, currency_model_1["default"].getById(id)];
                    case 1:
